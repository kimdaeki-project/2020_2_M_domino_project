		...
		<div class="deli-info form">
			...
			<dl>
				<dt class="dt1">이름</dt>
					<dd>
						<div class="form-item">
								<input type="text" id="order_name" name="order_name" maxlength="10">
						</div>
					</dd>
			</dl>
					...
					<dd>
						<div class="form">
							<div class="form-group2 select-group">
								<div class="form-item">
									<input type="text" id="tel2" name="order_phone" value="010" readonly="readonly">
									<input type="text" id="tel2" name="order_phone" maxlength="4">
									<input type="text" id="tel2" name="order_phone" maxlength="4">
								</div>
							</div>
						</div>
			...
			<dl>
				<dt class="dt3">요청사항</dt>
					<dd>
						<div class="form-item">
							<input type="text" id="order_request" name="order_request" value="" maxlength="50">
						</div>
					</dd>
			</dl>
					...
					<dd style="margin-top:1.3%;">
						<div class="form-item">
							<div class="chk-box v4" id="selectedSafe">
								<input type="checkbox" id="order_untact" name="order_untact" value="0">
									<label class="checkbox" for="order_untact"></label>
			...
			<div class="guide-box3" id="guide-box3-v1">&#42;주류상품이 포함된 경우 수령자의 신분증 확인을 위해 비대면 안전배달 서비스가 제한됩니다.</div>
		</div>
	...
	<div class="guide-box4">&#42;가장 높은 할인율의 혜택으로 자동 적용하였습니다.
		...
		<div class="discount-step">                  
			<ul>
				...
				<li id="mobile"  class="active">
					<a href="javascript:changePrmt('mobile');" class="type-brd5">통신사 및 카드사 제휴 프로모션 선택</a>
				</li>
				<li id="voucher"  class="active">
					<a href="javascript:changePrmt('voucher');" class="type-brd5 ">상품권 및 쇼핑몰 쿠폰번호 입력</a>
				</li>
			</ul>
		</div>	
	</div>
...
<!-- 도착 예정시간 -->
	<div class="step-wrap" id="time_info">	
		<div class="title-wrap">
			<div class="title-type"><strong>도착 예정시간</strong></div>
		</div>
		<div class="time-step">
					...
					<div class="pay-info">
						<div class="form-item">
							<div class="chk-box v3">
								<input type="checkbox" id="final_payment">
								<label class="checkbox" for="final_payment"></label>
								<label for="final_payment">기본 결제수단으로 등록</label>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="total-step">
				<ul>
					...
					<li class="discount">
						...
						<p class="price" style="color: red;">할인가격<em>원</em></p>
					</li>
						<li class="math">
						=
					</li>
