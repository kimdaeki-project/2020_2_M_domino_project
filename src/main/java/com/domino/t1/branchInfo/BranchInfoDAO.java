...
public class BranchInfoDAO {
	...
	public List<BranchInfoDTO> getBranchInfos(BranchInfoDTO branchInfoDTO) throws Exception {
		return sqlSession.selectList(NAMESPACE+"getBranchInfos", branchInfoDTO);
	}
