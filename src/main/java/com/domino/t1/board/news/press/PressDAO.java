...
@Repository
public class PressDAO implements NewsDAO {
	
	@Autowired
	private SqlSession sqlSession;
	private final String NAMESPACE="com.domino.t1.board.news.press.PressDAO.";
	...
	public int setPressHits(long board_num) throws Exception{
		return sqlSession.update("setPressHits", board_num);
	}
